...
2D космический шутер (в духе Galaga/Space Invaders / Radiant) на **MonoGame**. Кросс-платформенный:
...
В отличии от оригинальной RiotGalaxy, полностью написаной руками, тут применяется вайбкодинг.
Основная часть кода взята из первой игры, но подвергнута модификациям и дополнениям с помощью LLM
