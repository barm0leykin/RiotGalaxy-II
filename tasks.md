...
- [x] **Акт I целиком (м1–м5)** — миссии «Пивоварск/Гефест/Панацея/Пятёрочка/Зональск» с
      ...
      кампания `campaign.yaml` = [m1..m5]. Портреты-плейсхолдеры для всех говорящих.
- [ ] **Реальные арты** вместо портретов-плейсхолдеров; en-локаль диалогов; barks в бою.
...
- [~] **Портреты персонажей** — движок портретов готов (`DialogueLine.Portrait`); пока
      **плейсхолдеры** `Images/portrait_*` (цветная рамка + инициал). Нужны настоящие арты.
