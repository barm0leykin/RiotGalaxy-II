...
- [x] **Акт II целиком (м6–м9)** — «Сигма-Кита/Оружейные караваны/Тень бризанцев/Полевой командир»:
...
- [x] **Боссы с фазами и телеграфом** — [BossAI.cs](RiotGalaxy.Core/AI/BossAI.cs) (`ai: boss` в enemies.yaml):
      ...
      `boss` (финалы Акта I) и `ukroboss` (финал Акта II). *(Уязвимые зоны/мультиспрайт — позже.)*
